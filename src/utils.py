...
def load_data(data_path='../data/BraTS_2020/MICCAI_BraTS2020_TrainingData', test_mode=False):
    ...
    if test_mode:
        n = 40
        subj_ids = np.concatenate([subj_ids[: n // 2], subj_ids[- n // 2:]], axis=0)
        labels = np.vstack([np.tile([0, 1], (n // 2, 1)), np.tile([1, 0], (n // 2, 1))])
